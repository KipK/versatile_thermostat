        ...
        self._attr_extra_state_attributes.update(
            {
                ...
                "vtherm_over_switch": {
                    ...
                    "tpi_coef_int_heat": self._tpi_coef_int_heat,
                    "tpi_coef_ext_heat": self._tpi_coef_ext_heat,
                    "tpi_coef_int_cool": self._tpi_coef_int_cool,
                    "tpi_coef_ext_cool": self._tpi_coef_ext_cool,
                    "tpi_threshold_low": self._tpi_threshold_low,
                    "tpi_threshold_high": self._tpi_threshold_high,
